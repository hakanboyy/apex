...
function MetricCard({ title, value, subtitle, color, icon }) {
  return (
    ...
    >
      ...
      <p className="text-3xl font-bold" style={{ color: color || '#f1f5f9' }}>{value}</p>
  ...
  if (active && payload && payload.length) {
    return (
      <div
        ...
        style={{ backgroundColor: '#1e293b', borderColor: '#334155' }}
      >
        <p className="font-medium mb-1" style={{ color: '#f1f5f9' }}>{label}</p>
        {payload.map((p) => (
    ...
    <div className="flex flex-col gap-6">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div>
            <p className="text-sm font-semibold" style={{ color: '#f1f5f9' }}>Sprint Review</p>
